...
export default class Demo extends React.PureComponent {
  constructor(props) {
    ...
    this.state = {
      data: appointments,
      events: [], // Step 1: Add an array to store events
    };
    this.commitChanges = this.commitChanges.bind(this);
    this.handleCellClick = this.handleCellClick.bind(this); // Step 5: Bind the function
  }

  // existing code...

  // Step 2: Create a new function to handle cell click event
  handleCellClick(startDate) {
    ...
    const newEvent = {
      ...
      title: 'New Event',
      start: startDate,
      end: startDate, // You can set the end time as well if needed
    };
    this.setState(prevState => ({
      events: [...prevState.events, newEvent], // Step 4: Update the state with the new event
    }));
  }
