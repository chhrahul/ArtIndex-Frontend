...
function MyDropzone(props) {
    ...
    return (
        <>
            <div className="min-[480px]:grid min-[480px]:max-[992px]:gap-0 gap-8 border-2 border-blue-500 rounded-md">


                <div {...getRootProps()} className="align-middle mt-5 mr-8 min-[480px]:max-[992px]:ml-4 ">
                    <a href="/" className="w-full ml-4 flex flex-col items-center bg-white border-1 rounded-lg shadow md:flex-row hover:bg-gray-100 dark:border-blue-700 dark:bg-gray-1200 dark:hover:bg-gray-700 ">
                ...
                <div className="mb-5 ml-8 mr-8 grid grid-cols-4 gap-4">
                    {thumbs}
