                    ...
                    <div className="min-[480px]:m-20">
                        <div className="min-[480px]:grid grid-cols-12 ">
                            <div className="col-span-2">
                                ...
                                <p className='font-bold mt-8 text-sm'><input type="checkbox" className='mr-2 border-2 border-green-400  text-green-400  focus:border-green-400 focus:bg-green-400 focus:ring-0 dark:bg-green-400' />My Calendar</p>
                                <p className='font-bold mt-2 text-sm'><input type="checkbox" className='mr-2 border-2 border-purple-500 text-purple-500  focus:border-purple-500  focus:bg-purple-500 focus:ring-0 dark:bg-purple-500' />Shows</p>
                                <p className='font-bold mt-2 text-sm'><input type="checkbox" className='mr-2 border-2 border-teal-300 text-teal-300  focus:border-teal-300  focus:bg-teal-300 focus:ring-0 dark:bg-teal-300' />Meetings</p>
                                <p className='font-bold mt-2 text-sm '><input type="checkbox" className='mr-2 border-2 border-red-500 text-red-500  focus:borderred-500  focus:bg-red-500 focus:ring-0 dark:bg-red-500' />Events</p>
                            </div>
