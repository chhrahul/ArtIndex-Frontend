                                ...
                                <div className='min-[480px]:grid grid-cols-2 gap-12'>
                                    <div className=" ">
                                        ...
                                        <div className="w-full mt-12 bg-white dark:bg-white dark:border-blue-600">
                                            ...
                                            <input  {...register("Title", { required: true })} type="text" className="flex font-bold items-center justify-between border-2 italic border-blue-200 text-lg rounded-b-none divide-blue-400 sm:divide-x dark:divide-blue-400 w-full text-black bg-white focus:outline-0  rounded-lg text-md px-4 py-2.5  dark:bg-blue-600" defaultValue={data.Title} placeholder='Add Title' />

                                            <div className="px-4 py-2 border-l-2 border-r-2 border-b-2 border-blue-200 bg-white rounded-b-lg dark:bg-gray-800">
                                                <textarea {...register("Description", { required: true })} id="editor" rows="4" className="border-none block italic w-full px-0 focus:outline-0 text-md text-gray-800 bg-white focus:ring-0 dark:text-white dark:placeholder-gray-700" placeholder="Add Description" defaultValue={data.Description}></textarea>
                                        ...
                                        <select defaultValue={data.Type} {...register("Type", {
                                            required: true
                                        })}
                                        ...
                                        <input {...register("acrylicAndOil", {
                                            ...
                                            type="text" className="w-full text-black  border-2 border-blue-200 mt-3 bg-white focus:ring-2 focus:outline-none focus:ring-blue-500 font-bold rounded-lg text-md px-4 py-2.5  dark:bg-blue-600" placeholder="Acrylic and Oil on Canvas" defaultValue={data.acrylicAndOil} />
                                        {errors.acrylicAndOil && <span className='text-red-500'>This field is required</span>}

                                        <input {...register("natureExpression", {
                                            required: true
                                        })}
                                            type="text" className="w-full text-black  border-2 border-blue-200 mt-3 bg-white focus:ring-2 focus:outline-none focus:ring-blue-500 font-bold rounded-lg text-md px-4 py-2.5  dark:bg-blue-600" placeholder="Nature, Expression" defaultValue={data.natureExpression} />
                                        {errors.natureExpression && <span className='text-red-500'>This filed is required</span>}

                                        <input type="text" {...register("Inventory", {
                                            required: true
                                        })} className="w-full text-black  border-2 border-blue-200 mt-3 bg-white focus:ring-2 focus:outline-none focus:ring-blue-500 font-bold rounded-lg text-md px-4 py-2.5  dark:bg-blue-600" placeholder="Your Inventory " defaultValue={data.Inventory} />
                                        ...
                                        <div className="min-[480px]:grid grid-cols-2 gap-12 mt-8">
                                            <div className="">
                                                ...
                                                <input type="checkbox" {...register("signature")} className="ml-10 mr-10 text-blue-500 max-[768px]:ml-6 max-[768px]:mb-2 border-2 border-blue-500 mt-3 bg-white  focus:ring-0 font-bold  text-md   dark:bg-blue-600" checked={data.signature ? true : false} />
                                            </div>
                                            <div className="">
                                                <p className="text-sm font-bold text-gray-700 ml-4 min-[480px]:mt-2">Visibility</p>

                                                <select defaultValue={data.visiblity} {...register("visiblity", { required: true })} className="w-full text-black  border-2 border-blue-200 mt-3 bg-white hover:bg-white  focus:outline-none focus:ring-blue-500 font-bold rounded-lg text-md px-5 py-2.5 inline-flex items-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                                    ...
                                    <div className="">
                                        ...
                                        <div className="inline-flex mr-4">
                                            <input type="text" className="bg-white border-l-2 border-t-2 border-b-2 hover:bg-white border-blue-200  text-gray-800 font-bold py-2 px-4 rounded-l-lg w-14" placeholder='69' {...register("dimensionHeight")} defaultValue={data.dimensionHeight} />

                                            <input type="text" className="bg-white border-2 hover:bg-white border-blue-200 text-gray-800 font-bold py-2 px-4 w-14" placeholder='90' {...register("dimensionWidth")} defaultValue={data.dimensionWidth} />
                                        ...
                                        <select defaultValue={data.availability} {...register("availability")} className=" text-black  border-2 border-blue-200 mt-3 bg-white hover:bg-white focus:ring-2 focus:outline-none focus:ring-blue-500 font-bold rounded-lg text-md pl-2 py-2.5 pr-2 text-center inline-flex items-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                                            <option value="avail">Available</option>
                                            <option value="notavail">Not available</option>

                                        </select>

                                        <input type="number" {...register("salery")} className="max-[768px]:ml-0 max-[1024px]:ml-1 ml-6 mr-6 text-black  border-2 border-blue-200 mt-3 bg-white focus:ring-2 focus:outline-none focus:ring-blue-500 font-bold rounded-lg text-md px-4 py-2.5  dark:bg-blue-600 w-36" placeholder="8,500.00" defaultValue={data.salery} />
                                        <select defaultValue={data.IncomeType} {...register("IncomeType", {
                                            required: true
                                        ...
                                        <input type="checkbox" {...register("editions")} className="max-[768px]:mb-6 min-[480px]:max-[992px]:mt-0  ml-10 mr-10 text-blue-500  border-2 border-blue-500 mt-3 bg-white focus:ring-0 focus:outline-none focus:ring-blue-500 font-bold text-md   dark:bg-blue-600" checked={data.editions ? true : false} />
                                        <input {...register("editionFrom")} className=" text-black  border-2 border-blue-200 mt-3 bg-white hover:bg-white focus:ring-2 focus:outline-none focus:ring-blue-500 font-bold w-14 rounded-lg text-md py-2.5 text-center inline-flex items-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800 mr-6 min-[480px]:mr-1 max-[992px]:mr-1 " type="text" placeholder="13" defaultValue={data.editionTo}></input>
                                        /
                                        <input {...register("editionTo")} className=" text-black  border-2 border-blue-200 mt-3 bg-white hover:bg-white focus:ring-2 focus:outline-none focus:ring-blue-500 font-bold w-14 rounded-lg text-md py-2.5 text-center inline-flex items-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800 ml-6 min-[480px]:ml-1 max-[992px]:ml-1" type="text" placeholder="50" defaultValue={data.editionFrom}></input>
                                    </div>
                                </div>
                            </form>
