    ...
    <div className="min-[480px]:pt-10 sm:ml-48 min-[480px]:top-10 bg-gray-200 h-full" >
      <div className="min-[480px]:grid grid-cols-6">
        <div className='min-[480px]:flex col-span-5 ...'>
          <h2 className="dark:text-black text-3xl  mb-4 px-6" >Edit Contact</h2>
          {Loading ? (<>
                  ...
                  <div className="min-[480px]:grid grid-cols-6 gap-10 mt-4">
                    <div className='col-span-3'>
                      ...
                      <div className='flex mt-4 justify-between items-center'>
                        ...
                        <div>
                          <select defaultValue={data.emailType} {...register("emailType")} className="mt-4 text-black  border-2 border-blue-200  bg-white hover:bg-white focus:ring-2 focus:outline-none focus:ring-blue-500 font-bold rounded-lg text-md px-4 py-2  text-center inline-flex items-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                        ...
                        })} className="text-black  border-2 border-blue-200 mt-3 bg-white focus:ring-2 focus:outline-none focus:ring-blue-500  rounded-lg text-md px-4 dark:bg-blue-600 w-60 ml-2" placeholder="E-mail" defaultValue={data.Email} />
                      ...
                      <div className='flex mt-2 justify-between items-center'>
                        ...
                        <select defaultValue={data.phoneType} {...register("phoneType")} className="mt-4 text-black  border-2 border-blue-200  bg-white hover:bg-white focus:ring-2 focus:outline-none focus:ring-blue-500 font-bold rounded-lg text-md px-4 py-2  text-center inline-flex items-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                          <option value="Work">Work</option>
                          <option value="Personal">Personal</option>
                        </select>
                        <input type="number"  {...register("PhoneNumber", { required: true, maxLength: 10 })} className="text-black  border-2 border-blue-200 mt-3 bg-white focus:ring-2 focus:outline-none focus:ring-blue-500  rounded-lg text-md px-4 dark:bg-blue-600 w-60  ml-2" placeholder="Phone Number" defaultValue={data.PhoneNumber} />
                      ...
                      {/* {data.phoneNumber && data.phoneNumber.map((phone, index) => {
                        return (
                          <div className='flex mt-2 justify-between items-center'>
                            <span className='mt-6 mr-4'><IoIosCall size={30} color='gray' /></span>
                            <select defaultValue={phone.typeof}  className="mt-4 text-black  border-2 border-blue-200  bg-white hover:bg-white focus:ring-2 focus:outline-none focus:ring-blue-500 font-bold rounded-lg text-md px-4 py-2  text-center inline-flex items-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                              <option value="Work">Work</option>
                              <option value="Personal">Personal</option>
                            </select>
                            <input type="number"  className="text-black  border-2 border-blue-200 mt-3 bg-white focus:ring-2 focus:outline-none focus:ring-blue-500  rounded-lg text-md px-4 dark:bg-blue-600 w-60  ml-2" placeholder="Phone Number" defaultValue={phone.phone} />
                      ...
                      <div className='flex mt-2 justify-between items-center'>
                        ...
                        <select defaultValue={data.webType}  {...register("webType")} className="mt-4 text-black  border-2 border-blue-200  bg-white hover:bg-white focus:ring-2 focus:outline-none focus:ring-blue-500 font-bold rounded-lg text-md px-4 py-2  text-center inline-flex items-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                          <option >Work</option>
                          <option >Personal</option>
                        </select>
                        <input type="text"
                    ...
                    <div className='col-span-3'>
                      ...
                      <div className='flex mt-2'>
                        ...
                        <select defaultValue={data.addressType} {...register("addressType")} className="h-12 mt-4 text-black  border-2 border-blue-200  bg-white hover:bg-white focus:ring-2 focus:outline-none focus:ring-blue-500 font-bold rounded-lg text-md px-4 py-2  text-center inline-flex dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800" control={control}>
                          <option value="work">Work</option>
                          <option value="personal">Personal</option>
                        </select>
