                      ...
                      <div className="ml-12 min-[480px]:grid grid-cols-2 gap-2 mt-8">
                        <div className="">
                          ...
                          <div className="inline-flex mr-4 mt-4 mb-4">
                            <input type="text" className="bg-white border-l-2 border-t-2 border-b-2 hover:bg-white border-blue-200  text-black py-2 px-4  rounded-l-lg w-14" {...register("BirthDateMonth")} placeholder='M' defaultValue={data.BirthDateMonth} />
                        ...
                        <div className="">
                          ...
                          <div className="inline-flex mr-4 mt-4 mb-4">
                            <input type="text" className="bg-white border-l-2 border-t-2 border-b-2 hover:bg-white border-blue-200  text-black py-2 px-4  rounded-l-lg w-14" {...register("DeathDateMonth")} placeholder='M' defaultValue={data.DeathDateMonth} />
